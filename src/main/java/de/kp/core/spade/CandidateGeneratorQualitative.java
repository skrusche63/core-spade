...
import de.kp.core.spade.creator.AbstractionCreatorQualitative;
import de.kp.core.spade.creator.ItemAbstractionPairCreator;

public class CandidateGeneratorQualitative implements CandidateGenerator {

    /**
     * Static reference in order to make the class singleton
     */
    private static CandidateGeneratorQualitative instance = null;
     ...
     */
    private CandidateGeneratorQualitative() {
    }
     ...
     * @return
     */
    public static CandidateGeneratorQualitative getInstance() {
        if (instance == null) {
            instance = new CandidateGeneratorQualitative();
        }
        return instance;
    }
    ...
    public List<Pattern> generateCandidates(Pattern pattern1, Pattern pattern2, int minSupport, boolean doNotExploreXY, boolean doNotExploreYX, boolean doNotExploreX_Y, boolean doNotExploreY_X) {
        ...
        if (joinBitmap.cardinality() >= minSupport) {//If that is the case
            ...
            AbstractionCreatorQualitative qualitativeCreator = AbstractionCreatorQualitative.getInstance();
            ...
            AbstractionQualitative abstractionOfLastPairOfPattern1 = ((AbstractionQualitative) lastPairOfPattern1.getAbstraction());
            AbstractionQualitative abstractionOfLastPairOfPattern2 = ((AbstractionQualitative) lastPairOfPattern2.getAbstraction());
...
//        }
         ...
         */
        if (((AbstractionQualitative) lastPair.getAbstraction()).hasEqualRelation()) { // PFV-2013
