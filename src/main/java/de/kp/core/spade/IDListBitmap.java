...
public class IDListBitmap implements IDList {
     ...
     */
    public IDListBitmap(Map<Integer, BitSet> sequenceItemsetEntries) {
    ...
    public IDList join(IDList idList, boolean equals, int minSupport) {
        ...
        Map<Integer, BitSet> intersection = new HashMap<Integer, BitSet>(((IDListBitmap) idList).getSeqItemsetEntries().size());
        //We create an empty bitset where we will keep the pattern appearances
        BitSet newSequences = new BitSet(getSeqItemsetEntries().size());
        //Cast in the argument IdList
        IDListBitmap idStandard = (IDListBitmap) idList;
        //And we get the map of entries of bitsets
        Map<Integer, BitSet> idListMap = idStandard.getSeqItemsetEntries();
     ...
     */
    public Map<Integer, BitSet> getSeqItemsetEntries() {
