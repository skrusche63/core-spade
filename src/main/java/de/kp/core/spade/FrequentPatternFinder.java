...
public class FrequentPatternFinder {
     ...
     */
    public FrequentPatternFinder(CandidateGenerator candidateGenerator, double minSupportAbsolute, Saver saver) {
    ...
    public void setFrequentPatterns(int patronesFrecuentes) {
        FrequentPatternFinder.frequentPatterns = patronesFrecuentes;
    }
